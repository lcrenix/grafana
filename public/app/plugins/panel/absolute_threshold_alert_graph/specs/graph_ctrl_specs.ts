...
import {AbsoluteThresholdAlertGraphCtrl} from '../module';
import helpers from '../../../../../test/specs/helpers';

describe('AbsoluteThresholdAlertGraphCtrl', function() {
  ...
  beforeEach(ctx.createPanelController(AbsoluteThresholdAlertGraphCtrl));
  beforeEach(() => {
